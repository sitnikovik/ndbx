...
> ⚡️ Не ищите лайк, чтобы проверить, что он есть - **обновляйте** запись **сразу**, даже если записи еще нет
...
A: Если лайк уже был - произойдет обновление текущей записи или создание новой.
...
A: Да, необходимо создать ключевое пространство и таблицу `event_reactions`
