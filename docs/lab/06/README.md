...
Добавьте **еще 2 узла** Cassandra в конфигурацию приложения и измените уровень консистентности.

```sh
# Список хостов Cassandra в виде строки, разделенной запятыми (достаточно указать seed-ноду)
