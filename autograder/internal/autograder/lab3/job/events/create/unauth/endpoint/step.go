...
const (
	...
	Name = "Create Event Endpoint Unauthenticated"
	// Description is a brief description of the step.
	Description = "Checks that unauthenticated users cannot create events and receive the appropriate error response"
)
