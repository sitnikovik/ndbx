...
const (
	...
	Name = "Sign-Up Mongo Step"
	// Description is a brief description of the step.
	Description = "Checks if the user document was created in the database after signing up, " +
...
// Step represents the MongoDB sign-up step in the autograder process.
type Step struct {
