...
// Created represents the creation details of an event, including the timestamp and the user who created it.
type Created struct {
...
func NewCreated(at time.Time, by user.Identity) Created {
	return Created{
		at: at,
		by: by,
	}
